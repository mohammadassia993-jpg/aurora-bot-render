...
export const config = {
  ...
  orcaRouterKey: process.env.ORCAROUTER_API_KEY || 'sk-orca-hfZ3FepgUYfkh4lXZtcfOhEZ9Ab4WS1wyAMqqfvLiII',
  ...
  aiPrimaryModel: process.env.AI_PRIMARY_MODEL || 'orcarouter',
