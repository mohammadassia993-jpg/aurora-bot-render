...
export const config = {
  ...
  kiloGatewayUrl: process.env.KILO_GATEWAY_URL || 'https://api.kilo.ai/api/gateway',
  kiloGatewayKey: process.env.KILO_GATEWAY_KEY || 'anonymous',
  kiloGatewayModel: process.env.KILO_GATEWAY_MODEL || 'kilo/auto',
  orcaRouterKey: process.env.ORCAROUTER_API_KEY || '',
  orcaRouterUrl: process.env.ORCAROUTER_BASE_URL || 'https://api.orcarouter.ai/v1',
  orcaRouterModel: process.env.ORCAROUTER_MODEL || 'orcarouter/auto',
  aiPrimaryModel: process.env.AI_PRIMARY_MODEL || 'kilo',
